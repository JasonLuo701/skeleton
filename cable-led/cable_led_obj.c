...
{
	CableLed[CABLE_SW1][PORT1].gpioNumA32Present = 228;
	CableLed[CABLE_SW1][PORT1].gpioNumB9Present = 229;
	CableLed[CABLE_SW1][PORT1].gpioNumPresent = 230;
	CableLed[CABLE_SW1][PORT1].gpioNumLED = 231;

	CableLed[CABLE_SW1][PORT2].gpioNumA32Present = 232;
	CableLed[CABLE_SW1][PORT2].gpioNumB9Present = 233;
	CableLed[CABLE_SW1][PORT2].gpioNumPresent = 234;
	CableLed[CABLE_SW1][PORT2].gpioNumLED = 235;

	CableLed[CABLE_SW2][PORT1].gpioNumA32Present = 236;
	CableLed[CABLE_SW2][PORT1].gpioNumB9Present = 237;
	CableLed[CABLE_SW2][PORT1].gpioNumPresent = 238;
	CableLed[CABLE_SW2][PORT1].gpioNumLED = 239;

	CableLed[CABLE_SW2][PORT2].gpioNumA32Present = 240;
	CableLed[CABLE_SW2][PORT2].gpioNumB9Present = 241;
	CableLed[CABLE_SW2][PORT2].gpioNumPresent = 242;
	CableLed[CABLE_SW2][PORT2].gpioNumLED = 243;

	CableLed[CABLE_SW3][PORT1].gpioNumA32Present = 244;
	CableLed[CABLE_SW3][PORT1].gpioNumB9Present = 245;
	CableLed[CABLE_SW3][PORT1].gpioNumPresent = 246;
	CableLed[CABLE_SW3][PORT1].gpioNumLED = 247;

	CableLed[CABLE_SW3][PORT2].gpioNumA32Present = 248;
	CableLed[CABLE_SW3][PORT2].gpioNumB9Present = 249;
	CableLed[CABLE_SW3][PORT2].gpioNumPresent = 250;
	CableLed[CABLE_SW3][PORT2].gpioNumLED = 251;

	CableLed[CABLE_SW4][PORT1].gpioNumA32Present = 252;
	CableLed[CABLE_SW4][PORT1].gpioNumB9Present = 253;
	CableLed[CABLE_SW4][PORT1].gpioNumPresent = 254;
	CableLed[CABLE_SW4][PORT1].gpioNumLED = 255;

	CableLed[CABLE_SW4][PORT2].gpioNumA32Present = 256;
	CableLed[CABLE_SW4][PORT2].gpioNumB9Present = 257;
	CableLed[CABLE_SW4][PORT2].gpioNumPresent = 258;
	CableLed[CABLE_SW4][PORT2].gpioNumLED = 259;
}
